      ...
      <div className="p-5 md:p-8 xl:p-10 max-w-7xl mx-auto space-y-7 pb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            ...(isHOD ? [] : [{ label: 'Sections',          value: stats.departmentInfo.sections,  icon: 'meeting_room',    color: 'teal',   sub: 'Active sections' }]),
          ].map(s => (
            <div key={s.label}
        ...
        <div className={`grid ${isHOD ? 'lg:grid-cols-3' : 'lg:grid-cols-3'} gap-5`}>
            ...
            <div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  ...(isHOD ? [] : [{ label: 'Sections',         value: stats.departmentInfo.sections }]),
